...
================================================== */
	...
	//===== Default datatable =====//
	oTable2 = $('.datatable-dinamic table').dataTable({
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "http://www.centralliguesite.com.br/wiki/empresa/listar_empresaFN/",
	...
	$('.refresh_datatable').bind('click',function(){
		console.log(oTable2);
		//oTable.fnDraw;
	});
	//oTable.fnDestroy();
	...
	oTable = $('.datatable-invoices table').dataTable({
		...
		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
		"oLanguage": {
			"sSearch": "<span>Filtro resumo:</span> _INPUT_",
			"sLengthMenu": "<span>Mostrar:</span> _MENU_",
			"oPaginate": { "sFirst": "Primeira", "sLast": "Última", "sNext": ">", "sPrevious": "<" }
		},
		"aoColumnDefs": [
	...
	oTable = $('.datatable-tasks table').dataTable({
		...
		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
		"oLanguage": {
			"sSearch": "<span>Filtrar alertas:</span> _INPUT_",
			"sLengthMenu": "<span>Mostrar alertas:</span> _MENU_",
			"oPaginate": { "sFirst": "Primeira", "sLast": "Última", "sNext": ">", "sPrevious": "<" }
		},
		"aoColumnDefs": [
	...
	//===== Table with sem hospedagem =====//

	oTable = $('.datatable-sem-hospedagem table').dataTable({
		"aaSorting": [],
		"bJQueryUI": false,
		"bAutoWidth": false,
		"sPaginationType": "full_numbers",
		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
		"oLanguage": {
			"sSearch": "<span>Filtro sem hospedagem:</span> _INPUT_",
			"sLengthMenu": "<span>Mostrar tasks:</span> _MENU_",
			"oPaginate": { "sFirst": "Primeira", "sLast": "Última", "sNext": ">", "sPrevious": "<" }
		},
		"iDisplayLength" : 25,
		"aoColumnDefs": [
	...
	oTable = $('.datatable-custo-6 table').dataTable({
		"aaSorting": [],
		"bJQueryUI": false,
		"bAutoWidth": false,
		"sPaginationType": "full_numbers",
		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
		"oLanguage": {
			"sSearch": "<span>Filtro custo 6:</span> _INPUT_",
			"sLengthMenu": "<span>Mostrar tasks:</span> _MENU_",
			"oPaginate": { "sFirst": "Primeira", "sLast": "Última", "sNext": ">", "sPrevious": "<" }
		},
		"iDisplayLength" : 50,
	...
	oTable = $('.datatable-custo-8 table').dataTable({
		"aaSorting": [],
		"bJQueryUI": false,
		"bAutoWidth": false,
		"sPaginationType": "full_numbers",
		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
		"oLanguage": {
			"sSearch": "<span>Filtro custo 8:</span> _INPUT_",
			"sLengthMenu": "<span>Mostrar tasks:</span> _MENU_",
			"oPaginate": { "sFirst": "Primeira", "sLast": "Última", "sNext": ">", "sPrevious": "<" }
		},
		"iDisplayLength" : 50,
	...
	oTable = $('.datatable-custo-12 table').dataTable({
		"aaSorting": [],
		"bJQueryUI": false,
		"bAutoWidth": false,
		"sPaginationType": "full_numbers",
		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
		"oLanguage": {
			"sSearch": "<span>Filtro custo 12:</span> _INPUT_",
			"sLengthMenu": "<span>Mostrar tasks:</span> _MENU_",
			"oPaginate": { "sFirst": "Primeira", "sLast": "Última", "sNext": ">", "sPrevious": "<" }
		},
		"iDisplayLength" : 50,
	...
	oTable = $('.datatable-sem-cobranca table').dataTable({
		"aaSorting": [],
		"bJQueryUI": false,
		"bAutoWidth": false,
		"sPaginationType": "full_numbers",
		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
		"oLanguage": {
			"sSearch": "<span>Filtro hospedagem do mês:</span> _INPUT_",
			"sLengthMenu": "<span>Mostrar tasks:</span> _MENU_",
			"oPaginate": { "sFirst": "Primeira", "sLast": "Última", "sNext": ">", "sPrevious": "<" }
		},
		"iDisplayLength" : 50,
	...
	var oTable = $('.datatable-add-row table').dataTable({
		...
		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
		"oLanguage": {
			"sSearch": "<span>Filtro all:</span> _INPUT_",
			"sLengthMenu": "<span>Mostrar:</span> _MENU_",
			"oPaginate": { "sFirst": "Primeira", "sLast": "Última", "sNext": ">", "sPrevious": "<" }
		}
    });
	...
	$('.dataTables_filter input[type=text]').attr('placeholder','Buscar por...');
...
================================================== */
	...
	$(".validate").validate({
	    ...
	    success: function(label) {
	    	label.text('Correto!').addClass('valid');
	    }
	});
...
================================================== */
    ...
    $( ".datepicker-trigger" ).datepicker({
		...
		prevText: 'Anterior',
		showOn: "button",
		buttonImage: "http://www.centralliguesite.com.br/wiki/application/third_party/images/interface/datepicker_trigger.png",
...
================================================== */
	...
	function(start, end) {
		var start_s = start.format('YYYYMMDD');
		var end_s = end.format('YYYYMMDD');
		window.location.href="http://www.centralliguesite.com.br/meuweb/search/filter/"+start_s+'-'+end_s;
		//$.jGrowl('O período de busca foi alterado', { header: 'Update', position: 'center', life: 1500 });
...
================================================== */
	...
	$('.run-second').click(function(){
	    $('body').append('<div class="overlay"><div class="opacity"></div><i class="icon-spinner6 spin"></i></div>');
		$('.overlay').fadeIn(150);
		window.setTimeout(function(){
	        $('.overlay').fadeOut(150, function() {
	        	$(this).remove();
	...
	$('.sidebar-toggle').click(function () {
		...
		if($('.sidebar-right-notify:visible').size()>0)
		{
			//$('.page-container').toggleClass('sidebar-hidden');
			//$('.sidebar-hidden').css('margin','0 240px 0 0');
		}else{
			$('.page-container').toggleClass('sidebar-hidden-hidden');
		}
	});
	...
	{
		if($('.sidebar-narrow').size()>0)
		{
		
		}else{
			if($('.page-container').hasClass('sidebar-hidden-hidden'))
			{
				$('.page-container').toggleClass('sidebar-hidden-hidden');
			}
			$(".other-call").animate({
				...
				$(this).toggleClass('sidebar-right-notify');
				$(this).toggleClass('sidebar-right-call');
			});
			
			$('.page-content').toggleClass('page-content-notification');
			//$('.sidebar-hidden').toggleClass('sidebar-hidden-notification-hidden');
			
			//get function to show sidebar right notify
			//get timestamp
			var d = new Date();
			//get if exist box right in browser
			var boxexists = ''; 
			setTimeout(function(){
				boxexists = $('.sidebar-right-notify:visible').size();
				if(boxexists>0)
					getContent(boxexists);
			},500);
		}
	});

	//===== Show count register people notification =====//

	$('.sidebar-count-people-toggle').click(function () 
	{
		if($('.dropdown-count-people:visible').size()<1)
		{
			getCountPeople();
		}
	});
	...
	$('.sidebar-count-messages-toggle').click(function () 
	{
		if($('.dropdown-count-messages:visible').size()<1)
		{
			getContentMessages();
		}
	});
	...
	$(".modal-clean").click(function(event) {
