...
$html = '
 ...
 <div style="margin-left:130px;">
      <div>
            ...
            <h3 class="panel-title">Clientes Jurídicos</h3>
 ...
 ';
    foreach($usuario_juridico as $key=>$value){

    $html .= '<tr>';

        $html .= '<td >'.$usuario_juridico[$key]['cod_cliente'].'</td>';
        $html .= '<td>'.$usuario_juridico[$key]['nome'].'</td>';
        $html .= '<td>'.$usuario_juridico[$key]['ra_social'].'</td>';
        $html .= '<td>'.$usuario_juridico[$key]['cnpj'].'</td>';
        $html .= '<td>'.$usuario_juridico[$key]['cep'].'</td>';
        $html .= '<td>'.$usuario_juridico[$key]['estado'].'</td>';
