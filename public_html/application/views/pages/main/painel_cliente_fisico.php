 ...
 <?php	
 	...
 	$data['tamanho_utilizado'] = $tamanho_utilizado;
   	$data['lista_arquivos'] = $lista_arquivos;
   	$data['lista_imagens'] = $lista_imagens;
 ?> 
...
<body style="overflow-x:hidden !important;">
	...
	<div class="page-container">
	    ...
	    <div class="container">
	        ...
	        <div class="row row-offcanvas row-offcanvas-left" style="height:800px;display: flex;">

	        

		        <div class="col-xs-12 col-sm-9" style="width: 90%;margin-bottom: 100px;">
				...
				<div class="alert alert-danger" style="display:none;" id="failedUpdate" role="alert">Operação realizada com erro !</div>
                    ...
                    <form action="<?php echo $urlPjt; ?>/cliente/updateClientAvancadoFisicoPainel" method="POST">
	                    ...
	                    <table class="col-sm-11">
							...
							<tr style="padding:2px;">
								...
								<td class="pull-right col-sm-8">
									...
									<input onblur="ValidaCampoCpf()" maxlength="14" id="cpf" name="cpf" value="<?php echo $cpf; ?>" placeholder="111.111.111-11" class="form-control" type="text">
			...
			<?php $data['cod_cliente'] = $cod_cliente; $this->load->view('pages/main/galeria_cliente',$data); ?>	
			<!-- /adicionar_usuario_adm -->		
			<?php $data['cod_cliente'] = $cod_cliente; $this->load->view('pages/main/adicionar_usuario_adm',$data); ?>
