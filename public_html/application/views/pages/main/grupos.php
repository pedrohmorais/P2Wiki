	        ...
	        <div class="row row-offcanvas row-offcanvas-left">
		        ...
		        <div class="col-xs-10 col-sm-10" >
                    <ul class="nav nav-tabs">
                        <li role="presentation" class="active"><a href="#">Grupos que administro.</a></li>
                        <li role="presentation"><a href="grupos">Grupos que pertenço.</a></li>
                    </ul>           
                            ...
                            <table class="table" id="tabelaCategorias">
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-1 text-center">
                                        <a href="grupos/my_owns_config" style="color: rgb(51, 51, 51);" rel="modal" class="iframe">
