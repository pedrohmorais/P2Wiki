        ...
        <div class="container">
            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col-xs-10 col-sm-10" >
                    ...
                    <div style="width: 100%; height: auto; border-left: 1px solid #ddd;padding:5px;">
                            ...
                            <table class="table" id="tabelaCategorias">
                                <thead>
                                    <tr class="filters">
                                        ...
                                        <th><input type="text" placeholder="Detalhes" id="configGroup" disabled="" class="nao_desabilitar form-control text-center"></th>
                                ...
                                <?php
                                    if(count($info_grupos)>0 && is_array($info_grupos)){
                                        foreach ($info_grupos as $info_grupo) {
                                            ...
                                            echo '        <a href="'.site_url().'grupos/group_stats/'.$info_grupo['group_id'].'" style="color: rgb(51, 51, 51);" rel="modal" class="iframe">';
                                            echo '            <span data-placement="top" data-toggle="popover" data-content="Clique para ver os detalhes do grupo." style="font-size:16px;" class=" hidden-xs showopacity glyphicon glyphicon-list-alt"></span>';
                                            echo '        </a>';
                                            echo '     </td>';
                                            echo '    <td class="col-sm-1 text-center">';
                                            if($info_grupo['ativo'] == 0){
                                                echo '        <span id="glyphicon'.$info_grupo['group_id'].'" style="font-size:16px;color:red;" class="hidden-xs showopacity glyphicon ';
                                                ...
                                                echo ' <span id="glyphicon'.$info_grupo['group_id'].'" style="font-size:16px;color:green;" class="hidden-xs showopacity glyphicon ';
                                                echo 'glyphicon-ok';
